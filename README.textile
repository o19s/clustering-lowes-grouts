...
So I thought, instead of trying to build a mental model of all thirty results, why don't I leverage clustering to see if I can pull out of the unstructured data some shared clusters that would act as facets?   This blog post and the "accompanying code":https://github.com/o19s/clustering-lowes-grouts at is going to walk you through how I did this.
